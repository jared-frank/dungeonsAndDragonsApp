...
public class SpellSlotEngine {
    ...
    public static final Map<Integer, int[]> FULL_CASTER_SLOTS = Map.ofEntries(
        ...
        Map.entry( 3, new int[]{4, 2, 0, 0, 0, 0, 0, 0, 0}),
        Map.entry( 4, new int[]{4, 3, 0, 0, 0, 0, 0, 0, 0}),
        Map.entry( 5, new int[]{4, 3, 2, 0, 0, 0, 0, 0, 0}),
        Map.entry( 6, new int[]{4, 3, 3, 0, 0, 0, 0, 0, 0}),
        Map.entry( 7, new int[]{4, 3, 3, 1, 0, 0, 0, 0, 0}),
        Map.entry( 8, new int[]{4, 3, 3, 2, 0, 0, 0, 0, 0}),
        Map.entry( 9, new int[]{4, 3, 3, 3, 1, 0, 0, 0, 0}),
        Map.entry(10, new int[]{4, 3, 3, 3, 2, 0, 0, 0, 0}),
        Map.entry(11, new int[]{4, 3, 3, 3, 2, 1, 0, 0, 0}),
        Map.entry(12, new int[]{4, 3, 3, 3, 2, 1, 0, 0, 0}),
        Map.entry(13, new int[]{4, 3, 3, 3, 2, 1, 1, 0, 0}),
        Map.entry(14, new int[]{4, 3, 3, 3, 2, 1, 1, 0, 0}),
        Map.entry(15, new int[]{4, 3, 3, 2, 2, 1, 1, 1, 0}),
        Map.entry(16, new int[]{4, 3, 3, 3, 2, 1, 1, 1, 0}),
